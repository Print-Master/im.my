...
//        filters_categories.name,filters_categories.id,filters.id as TABLE filters TABLE_id,filters.name as TABLE filters TABLE_name,filters.id as TABLE filters TABLE_id FROM filters_categories LEFT JOIN filters ON filters_categories.id=filters.parent_id
//        $query = "SELECT filters.id as TABLE filters TABLE_id,filters.name as TABLE filters TABLE_name,filters.id as TABLE filters TABLE_id FROM filters_categories LEFT JOIN filters ON filters_categories.id=filters.parent_id";
