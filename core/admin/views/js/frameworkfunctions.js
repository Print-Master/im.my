...
Element.prototype.sortable = (function(){
    ...
    function _unDraggable(elements) {
        ...
        return function (option) {
                    ...
                    this.onUpdate = option.stop || null;
                    let excludedElements = option.excludedElements && option.excludedElements.split(/,*\s+/) || null;
